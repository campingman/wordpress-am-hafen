...
== Description ==
EduTheme is a modernized take on an ever-popular WordPress layout — the horizontal masthead with an optional right sidebar that works perfectly for blogs and websites. It has custom color options with beautiful default color schemes, a harmonious fluid grid using a mobile-first approach, and impeccable polish in every detail. EduTheme will make your WordPress look beautiful everywhere.
...
For more information about EduTheme please go to https://codex.wordpress.org/Twenty_Sixteen.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in EduTheme in the search form and press the 'Enter' key on your keyboard.
...
EduTheme WordPress Theme, Copyright 2014-2015 WordPress.org
EduTheme is distributed under the terms of the GNU GPL
...
EduTheme Theme bundles the following third-party resources:
